...
public class BloodParticleSystemHandler : MonoBehaviour
{
    ...
    public void SpawnBlood(Vector3 position, Vector3 direction, Color color)
    {
        ...
        {
            singleList.Add(new Single(position, UtilsClass.ApplyRotationToVector(direction, Random.Range(-15f, 15f)),
                meshParticleSystem, color));
        }
    }
    ...
    private class Single
    {
        ...
        public Single(Vector3 position, Vector3 direction, MeshParticleSystem meshParticleSystem, Color color)
        {
